        ...
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <a href="#" class="navbar-brand">Siatec Perú / Categoria</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="categoria-form">
                            <input type="hidden" id="id_categoria" name="id_categoria" value="" class="form-control">
                            <div class="form-group">
                                <input type="text" id="nombre_categoria" placeholder="Nombre" name="nombre_categoria" value="" class="form-control">
                            </div>

                            <div class="form-group">
                                <input type="text" id="descripcion" placeholder="Descripción" name="descripcion" value="" class="form-control">
                            </div>

                            <button type="submit" name="guardar" id="guardar" class="btn btn-primary btn-block text-center"> Guardar Categoria</button>
                        </form>
                    </div>
                </div>
            </div>
